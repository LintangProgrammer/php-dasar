...
class TiketBioskop
{
    public $jumlah, $hari, $studio, $film;
    public $harga = 50000;
    public $biayaweekend = 10000;
    public $biayavip = 20000;

    public function __construct($jumlah, $hari, $studio, $film)
    {
        $this->jumlah = $jumlah;
        $this->hari = $hari;
        $this->studio = $studio;
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $tiket = new TiketBioskop($jumlah, $hari, $studio, $film);
}
?>
...
<div class="container mt-5">
    <form method="post">
        <div class="card col-md-6 mx-auto p-4 shadow">
            <h4 class="text-center mb-4">CGV Cinemas</h4>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="kursi" class="form-label">Studio</label>
                <select class="form-select" name="studio" id="studio" required>
                    <option value="" selected disabled>Pilih Jenis Studio</option>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="film" id="film" required>
                    ...
                    <option value="">The Conjuring</option>
                    <option value="VIP">One For All</option>
                    <option value="VIP">Demon Slayer</option>
                    <option value="VIP">Weapons</option>
                </select>
            </div>
